...
my $mattached_path = '/opt/mpich_download/mpich-3.3.2/mpich_install/bin';#attached path in main script
	&path_setting($mattached_path);
my 	$mattached_ld = '/opt/mpich_download/mpich-3.3.2/mpich_install/lib';#attached ld path in main script
...
my %conditions;
$conditions{lmpexe} = "/opt/lammps-mpich-3.3.2/lmp_20201215 -l none -sc none -in"; # filename
...
my $Number_of_particles = 4;##@ p.132 c = 0.5 + ln2
